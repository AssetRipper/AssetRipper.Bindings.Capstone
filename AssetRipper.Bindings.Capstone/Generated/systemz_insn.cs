...
public enum systemz_insn
{
    ...
    SYSTEMZ_INS_ALIAS_VISTRB,
    SYSTEMZ_INS_ALIAS_VISTR,
    SYSTEMZ_INS_ALIAS_VFEEB,
    SYSTEMZ_INS_ALIAS_VFEE,
    SYSTEMZ_INS_ALIAS_VFAEB,
    SYSTEMZ_INS_ALIAS_VFAEBS,
    SYSTEMZ_INS_ALIAS_VFAE,
    SYSTEMZ_INS_ALIAS_VSTRSB,
    SYSTEMZ_INS_ALIAS_VSTRS,
    SYSTEMZ_INS_ALIAS_VSTRCB,
    SYSTEMZ_INS_ALIAS_VSTRCBS,
    SYSTEMZ_INS_ALIAS_VSTRC,
    SYSTEMZ_INS_ALIAS_VFAEH,
    SYSTEMZ_INS_ALIAS_VFAEHS,
    SYSTEMZ_INS_ALIAS_VFAEF,
    SYSTEMZ_INS_ALIAS_VFAEFS,
    SYSTEMZ_INS_ALIAS_VFAEZB,
    SYSTEMZ_INS_ALIAS_VFAEZBS,
    SYSTEMZ_INS_ALIAS_VFAEZH,
    SYSTEMZ_INS_ALIAS_VFAEZHS,
    SYSTEMZ_INS_ALIAS_VFAEZF,
    SYSTEMZ_INS_ALIAS_VFAEZFS,
    SYSTEMZ_INS_ALIAS_VFEEH,
    SYSTEMZ_INS_ALIAS_VFEEF,
    SYSTEMZ_INS_ALIAS_VFENE,
    SYSTEMZ_INS_ALIAS_VFENEB,
    SYSTEMZ_INS_ALIAS_VFENEH,
    SYSTEMZ_INS_ALIAS_VFENEF,
    SYSTEMZ_INS_ALIAS_VISTRH,
    SYSTEMZ_INS_ALIAS_VISTRF,
    SYSTEMZ_INS_ALIAS_VSTRCH,
    SYSTEMZ_INS_ALIAS_VSTRCHS,
    SYSTEMZ_INS_ALIAS_VSTRCF,
    SYSTEMZ_INS_ALIAS_VSTRCFS,
    SYSTEMZ_INS_ALIAS_VSTRCZB,
    SYSTEMZ_INS_ALIAS_VSTRCZBS,
    SYSTEMZ_INS_ALIAS_VSTRCZH,
    SYSTEMZ_INS_ALIAS_VSTRCZHS,
    SYSTEMZ_INS_ALIAS_VSTRCZF,
    SYSTEMZ_INS_ALIAS_VSTRCZFS,
    SYSTEMZ_INS_ALIAS_VSTRSH,
    SYSTEMZ_INS_ALIAS_VSTRSF,
